...
class ResumeFacade:
    def __init__(self, api_key, style_manager, resume_generator, resume_object, output_path):
        ...
        global_config.STRINGS_MODULE_RESUME_PATH = lib_directory / "resume_prompt/strings_search_apply.py"
        global_config.STRINGS_MODULE_RESUME_JOB_DESCRIPTION_PATH = lib_directory / "resume_job_description_prompt/strings_search_apply.py"
        global_config.STRINGS_MODULE_COVER_LETTER_JOB_DESCRIPTION_PATH = lib_directory / "cover_letter_prompt/strings_search_apply.py"
        global_config.STRINGS_MODULE_NAME = "strings_search_apply"
